...
function FieldLegend<T extends ValidComponent = "legend">(
  ...
  const [, rest] = splitProps(props as FieldLegendProps, [
    "class",
    "variant",
  ])
...
function FieldGroup<T extends ValidComponent = "div">(props: ComponentProps<T>) {
...
function FieldTitle<T extends ValidComponent = "div">(props: ComponentProps<T>) {
  const [, rest] = splitProps(props as ComponentProps<"div">, ["class"])
...
export type FieldErrorProps<T extends ValidComponent = "div"> = ComponentProps<T> & {
