		...
		<>
			...
			>
				...
				<nav class="flex-1 p-4 overflow-y-auto">
					...
					>
						<Globe size={20} />
						<span class="font-medium">Waitlist Form</span>
					</Link>

					<Link
						to="/demo/feedback-form"
						onClick={() => setIsOpen(false)}
						class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-800 transition-colors mb-2"
						activeProps={{
							class:
					...
					>
						<Globe size={20} />
						<span class="font-medium">Feedback Form</span>
					</Link>

					<Link
						to="/demo/sign-up-form"
						onClick={() => setIsOpen(false)}
						class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-800 transition-colors mb-2"
						activeProps={{
							class:
					...
					>
						<Globe size={20} />
						<span class="font-medium">Sign Up Form</span>
					</Link>
